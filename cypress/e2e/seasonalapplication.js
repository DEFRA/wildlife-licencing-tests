...
describe("Page title verification", () => {
  it("1 and verify application season period screen", () => {
    cy.request(
      "https://new-tst.aws.defra.cloud/set-sysdate?iso-string=2023-12-01T23:59:59.000Z"
    );
    cy.request(
  ...
  it("2 and verify application season period screen", () => {
    cy.request(
      "https://new-tst.aws.defra.cloud/set-sysdate?iso-string=2023-04-30T00:00:00.000Z"
    );
    cy.request(
      "https://new-tst.aws.defra.cloud/reset?username=user1@email.com"
    );
  ...
  it("3 and verify application season period screen", () => {
    cy.request(
      "https://new-tst.aws.defra.cloud/set-sysdate?iso-string=2023-11-30T00:00:00.000Z"
    );
    cy.request(
      "https://new-tst.aws.defra.cloud/reset?username=user1@email.com"
    );
  ...
  it("4 and verify application season period screen", () => {
    cy.request(
      "https://new-tst.aws.defra.cloud/set-sysdate?iso-string=2023-11-30T23:59:59.000Z"
    );
    cy.request(
      "https://new-tst.aws.defra.cloud/reset?username=user1@email.com"
    );
  ...
  it("5 and verify application season period screen", () => {
    cy.request(
      "https://new-tst.aws.defra.cloud/set-sysdate?iso-string=2023-03-31T23:59:59.000Z"
    );
    cy.request(
      "https://new-tst.aws.defra.cloud/reset?username=user1@email.com"
    );
  ...
  it("6 and verify application season period screen", () => {
    cy.request(
      "https://new-tst.aws.defra.cloud/set-sysdate?iso-string=2023-04-01T00:00:00.000Z"
    );
    cy.request(
      "https://new-tst.aws.defra.cloud/reset?username=user1@email.com"
    );
