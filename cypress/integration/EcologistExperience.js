...
describe("Ecologist experience", () => {
  ...
  it(" 4 Verify happy path - ecologist experience", () => {
    ...
    cy.fixture("users.json").then((users) => {
      ...
      cy.get("input[value='no']").click();
      cy.get("#continue").click();
      cy.get("#enter-experience").type(faker.random.alphaNumeric(200));
      cy.get("#continue").click();
      cy.get("#enter-methods").type(faker.random.alphaNumeric(200));
      cy.get("#continue").click();
      cy.get("input[value='no']").click();
      cy.get("#continue").click();
      cy.get("#continue").click();
  ...
  it(" 5 Verify happy path - ecologist experience", () => {
    ...
    cy.fixture("users.json").then((users) => {
      ...
      cy.get("input[value='no']").click();
      cy.get("#continue").click();
      cy.get("#enter-experience").type(faker.random.alphaNumeric(4));
      cy.get("#continue").click();
      cy.get("#enter-methods").type(faker.random.alphaNumeric(4));
      cy.get("#continue").click();
      cy.get("input[value='yes']").click();
      cy.get("#continue").click();
      cy.get("#enter-class-mitigation-details").type("BAD-2022-agsss1");
